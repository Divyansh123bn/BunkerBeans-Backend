package com.bunkerbeans.exception;
...
public class ExceptionControllerAdvice {
    ...
    public ResponseEntity<ErrorInfo> validatorExceptionHandler(Exception exception){
        ...
        if(exception instanceof MethodArgumentNotValidException manvException){
            ...
            ConstraintViolationException cnvException=(ConstraintViolationException)exception;
            msg=cnvException.getConstraintViolations().stream().map(ConstraintViolation::getMessage).collect(Collectors.joining(","));
        }
